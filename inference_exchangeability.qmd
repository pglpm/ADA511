# Inference under exchangeability {#sec-inference-freq}
{{< include macros.qmd >}}
...
Now we suppose that the agent additionally **knows the joint frequency distribution** for the variate $X$ in the population. Let's denote the frequencies of the values $1,2,\dotsc, K$ by $f_1, f_2, \dotsc, f_K$. The joint distribution is collectively denoted by $f$.
...
$$
\P(X_u \mo i,\ X_v\mo j \| f,\ \yI) = f_i \cdot f_j
$$
