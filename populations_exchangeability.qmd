...
2. Of the last 1000 patients admitted to a hospital and showing a particular symptom, [760 had pneumonia]{.green} and [280 were pneumonia free]{.green}. The admission times of these patients are not known. Which of the next 10 admitted patients with the same symptom will have [pneumonia]{.yellow}, and which will be [pneumonia-free]{.yellow}?
...
The amount of available data is different in the two inferences. The first inference, which appears more difficult, is conditional on a larger amount of data (3650 binary quantities) than the second (1000 binary quantities).



Yet the data in the first inference might be less informative, for inference purposes, than the data in the second.
