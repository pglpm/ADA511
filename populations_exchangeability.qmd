...
Consider these two sketches of inference problems about [stock exchange](https://www.britannica.com/money/topic/stock-exchange-finance) and Mars [prospecting](https://www.britannica.com/technology/prospecting-mining):

1. In 3650 days, the daily change in [closing price](https://www.investor.gov/introduction-investing/investing-basics/glossary/closing-price) of a stock has been [positive 2774 times, and negative 876 times]{.green}, in a particular order. So the data could be of the form
$$
\text{day 1:}\, \boldsymbol{+}\ ,
\quad
\text{day 2:}\, \boldsymbol{-}\ ,
\quad\dotso\ ,
\quad
\text{day 3650:}\, \boldsymbol{+} \ .
$$

    In which of the subsequent 10 days will the closing-price change be [positive]{.yellow}, and in which [negative]{.yellow}?
...
2. Of the last 1000 similar-sized rocks examined in a large crater on Mars, [760 contained [hematite](https://science.nasa.gov/science-news/science-at-nasa/2001/ast28mar_1), and 280 didn't]{.green}. So the data could be of the form
$$
\text{rock \#1:}\, \boldsymbol{-}\ ,
\quad
\text{rock \#2:}\, \boldsymbol{+}\ ,
\quad\dotso\ ,
\quad
\text{rock \#1000:}\, \boldsymbol{+} \ .
$$
Where ["$+$" and "$-$"]{.m} denote the presence and absence of hematite.

    Which of the next 10 rocks will contain [hematite]{.yellow}, and which will be [hematite-free]{.yellow}?
