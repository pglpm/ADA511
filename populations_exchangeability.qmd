...
Consider a joint probability distribution over a collection of quantities having the same domain, and conditional on some information $\yI$. Call the quantities $X_1$, $X_2$, $X_3$, and so on. This joint probability distribution is called [**exchangeable**]{.blue} if [*its values stay the same whenever the values of any two quantities are swapped*]{.blue}, for example

$$
\begin{aligned}
&\P(X_1 \mo \yHg,\ X_2\mo \yHg,\ X_3\mo \yNr,\ \dotsc \| \yI)
\\[1ex] {}={}&
\P(X_1 \mo \yNr,\ X_2\mo \yHg,\ X_3\mo \yHg,\ \dotsc \| \yI)
\\[1ex] {}={}&
\P(X_1 \mo \yHg,\ X_2\mo \yNr,\ X_3\mo \yHg,\ \dotsc \| \yI)
\end{aligned}
$$

and so on, *no matter how many quantities there are (the dots "$\dotsc$")*, and *for any values the quantities might have*.

:::{.callout-warning}
## {{< fa exclamation-circle >}}
This does not mean that all probabilities are equal. For instance we can have

$$
\P(X_1 \mo \yHg,\ X_2\mo \yHg,\ X_3\mo \yNr,\ X_4\mo \yNr \| \yI)
\mathrel{\boldsymbol{\ne}}
\P(X_1 \mo \yHg,\ X_2\mo \yHg,\ X_3\mo \yNr,\ X_4\mo \yHg \| \yI)
$$
...
\P(X_1 \mo \yHg,\ X_2\mo \yHg,\ X_3\mo \yNr,\ X_4\mo \yNr \| \yI)
\mathrel{\boldsymbol{=}}
\P(X_1 \mo \yNr,\ X_2\mo \yHg,\ X_3\mo \yNr,\ X_4\mo \yHg \| \yI)
$$
:::
