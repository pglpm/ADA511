...
## Statements: well-posed and ill-posed
...
an electric-car model [consumes
150 Wh/km](https://ev-database.org/cheatsheet/energy-consumption-electric-car)
and [has a range of
200 km](https://ev-database.org/cheatsheet/range-electric-car); a second
...
say that statement is not **well-posed**, or that it is **ill-posed**.
