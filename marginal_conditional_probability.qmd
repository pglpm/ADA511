...
$$
\P({\green X\mo x}\| \yI) = \sum_{\red y} \P({\red Y\mo y}, {\green X\mo x} \| \yI)
$$
...
$$
\P({\red Y\mo y} \| {\green X\mo x}, \yI) =
\frac{\P({\green X\mo x},{\red Y\mo y} \|\yI)}{\P({\green X\mo x} \| \yI)}
$$
...
$$
\P({\red Y\mo y} \| {\green X\mo x}, \yI) =
\frac{\P({\red Y\mo y}, {\green X\mo x} \|\yI)}{\sum_{\red y} \P({\red Y\mo y}, {\green X\mo x} \|\yI)}
$$
