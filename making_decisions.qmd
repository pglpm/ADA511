...
- §15.5 and chapter 16 of [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)
- Chapter 2 of [*Decision Analysis*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
...
::: {.callout-tip}
## {{< fa rocket >}} For the extra curious
- Chapter 8 of [*Rational Descriptions, Decisions and Designs*](https://hvl.instructure.com/courses/32045/modules)
- Box 11.1 (p. 351) of [*Risk Assessment and Decision Analysis with Bayesian Networks*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
...
::: {.callout-tip}
## {{< fa rocket >}} For the extra curious
- §15.6 of [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)
- §11.5 of [*Risk Assessment and Decision Analysis with Bayesian Networks*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
...
::: {.callout-tip}
## {{< fa rocket >}} For the extra curious
- Chapter 17 of [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
