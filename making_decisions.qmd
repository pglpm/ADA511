...
1. "Say 'go to location $\sA$' on the radio".
2. "Say 'go to location $\sB$' on the radio".
...
0. Use a random number generator to choose which of the options above to follow.

and in our decision problem include the possibility that the utilities have a small error, then a quick calculation shows that decision #0 is the one with maximal expected utility.
...
Show that, with this more precise diagram, decision #0 above  has indeed highest expected utility.
:::
