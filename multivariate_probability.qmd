...
\dotsc
$$
where $\yI$ is the agent's state of knowledge, and the probabilities sum up to one. We call this a [**multivariate**]{.blue} or [**joint probability distribution**]{.blue}. Usually these probabilities are written in much abbreviated form, and the $\land$ is represented by a comma; for instance you can commonly find the following notation:
$$
