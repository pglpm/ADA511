...
But consider now the case $\yul$ of a large collection of 3 000 000 cubes, 2 000 000 of which are labelled $\yy$ and the rest $\yn$. The population's relative frequencies are exactly as in the case with three cubes, and for the probability that cube #1 is labelled $\yy$ we still have
