...
Given $F\mo\vf$, we know that $F\mo\vf$ is true: $\P( F\mo\vf \| F\mo\vf \and \yi[U])=1$, which means
...
B_{2}\mo\yy \and 
B_{3}\mo\yy)
\|[\big] F\mo\vf \and \yi[U]\bigr]
\\[2ex]
&=
\P(B_{1}\mo\yy \and 
B_{2}\mo\yy \and 
B_{3}\mo\yn \| F\mo\vf \and \yi[U])
+{}
\\&\qquad
\P(B_{1}\mo\yy \and 
B_{2}\mo\yn \and 
B_{3}\mo\yy \| F\mo\vf \and \yi[U])
+{}
\\&\qquad
\P(B_{1}\mo\yn \and 
B_{2}\mo\yy \and 
...
Finally let's find the probability that the first ball we draw has mark $\yy$, that is, $\P(B_1\mo\yy \| F\mo\vf \and \yi[U])$. It's a marginal probability ([§ @sec-marginal-probs]), so it's given by the sum

$$
\begin{aligned}
\P(B_1\mo\yy \| F\mo\vf \and \yi[U]) &=
\sum_{i=\yy}^{\yn}\sum_{j=\yy}^{\yn}
\P(B_1\mo\yy \and B_2\mo i \and B_3\mo j \| F\mo\vf \and \yi[U])
\\[1ex]
&=
\P(B_1\mo\yy \and B_2\mo\yy \and B_3\mo\yy \| F\mo\vf \and \yi[U]) + {}
\\ &\qquad
\P(B_1\mo\yy \and B_2\mo\yy \and B_3\mo\yn \| F\mo\vf \and \yi[U]) + {}
\\ &\qquad
\P(B_1\mo\yy \and B_2\mo\yn \and B_3\mo\yy \| F\mo\vf \and \yi[U]) + {}
\\ &\qquad
\P(B_1\mo\yy \and B_2\mo\yn \and B_3\mo\yn \| F\mo\vf \and \yi[U])
\\[1ex]
&= 0 + 1/3 + 1/3 + 0
\\[1ex]
&= 2/3
...
\P(B_{1}\mo\yy \and 
B_{2}\mo\yy \and 
B_{3}\mo\yn \| F\mo\vf \and \yJ)
\\
\P(B_{1}\mo\yy \and 
B_{2}\mo\yn \and 
B_{3}\mo\yy \| F\mo\vf \and \yJ)
\\
\P(B_{1}\mo\yn \and 
B_{2}\mo\yy \and 
B_{3}\mo\yy \| F\mo\vf \and \yJ)
...
$$
\P(B_2\mo\yy \| B_1\mo\yy \and F\mo\vf \and \yi[U]') = 
...
$$
\begin{aligned}
\P(B_2\mo\yy \and B_1\mo\yy \| F\mo\vf \and \yi[U]') &=
\P(B_2\mo\yy \| B_1\mo\yy \and F\mo\vf \and \yi[U]') \cdot
\P(B_1\mo\yy \| F\mo\vf \and \yi[U]')
\\[1ex]
...
:::{.column-page-inset-right}
$$
\P(B_4\mo\yy \and B_3\mo\yn \and B_2\mo\yn \and B_1\mo\yy \| F\mo\vf \and \yi[U]')
\approx 
