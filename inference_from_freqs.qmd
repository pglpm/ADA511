...
Imagine an agent with exchangeable beliefs $\yI$ and knowledge $\if$ of the full-population frequencies, who also has observed several units with values (possibly some identical) $\blue Z_{\yellow u'}\mo z' \and Z_{\yellow u''}\mo z'' \and Z_{\yellow u'''}\mo z''' \and \dotsb$. What is this agent's degree of belief that a new unit $\yellow u$ has value $\blue Z\mo z$?
...
\\[3ex]
&\qquad{}\equiv
\P({\blue Z_{\yellow u}\mo z} \| \if \and \yI)
\end{aligned}
$$
