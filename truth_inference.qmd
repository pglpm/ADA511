...
The [bottom formula]{.red} is the target inference. Each horizontal line denotes the application of an inference rule, from one or more inferences above the line, to one below the line. The two formulae with no line above are our [starting inference]{.green} and a tautology.
