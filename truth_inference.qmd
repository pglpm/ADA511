...
$$
\green\tru(\lnot\yh \lor \lnot\ys \| \yf \land \yI) = 1
\ ,
\qquad
\tru(\ys \| \yf \land \yI) \ne 0
$$
...
&&\text{\small  ∧-rule}
\\
&\qquad=\frac{{\green\tru(\lnot\yh \land \lnot\ys \| \yf \land \yI)}-
...
:::{.callout-caution}
## {{< fa user-edit >}} Exercise
Prove the target inference $\red\tru(\lnot\yh \| \ys \land \yf \land \yI) = 1$ using the rules of truth-inference, but beginning from the starting inference [$\green\tru(\lnot\yh \land \lnot\ys \| \yf \land \yI)=1$.]{.m}
:::
