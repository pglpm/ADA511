...
:::{.column-margin}
![The bottom formula is our conclusion. Each line denotes the application of an inference rule. The two formulae with no line above are our initial, known inference, and a tautology.](failure_sequent.png){width=100%}
:::
