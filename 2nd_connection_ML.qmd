# A second connection with machine learning {#sec-1st-connection-ML}
{{< include macros.qmd >}}
...
but it can't be completely correct, because an agent gives the probabilities for several possible "outputs", it doesn't just yield one. This indicates that there must be also be some **decision** involved among the possible outputs.
