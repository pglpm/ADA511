...
which is a fraction between the probability for the "unsupervised case" (which we wrote above compactly in terms of $D$ rather than $(Y,X)$)

which shows that if the agent has the probability for the "unsupervised case"
