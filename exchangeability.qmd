...
$$\begin{gathered}
\P(H_{2}\mo\yy \| H_{101}\mo\yn,\ \yI)
= \P(H_{98}\mo\yy \| H_{8}\mo\yn,\ \yI)
\\[1ex]
\P(H_{99}\mo\yy,\ H_{7}\mo\yy,\ H_{3}\mo\yn \| \yI)
=\P(H_{4}\mo\yy,\ H_{102}\mo\yy,\ H_{95}\mo\yn \| \yI)
\end{gathered}$$
...
X_{14}\mo\yme \| X_{7}\mo\ylo,\ X_{1}\mo\yme,\ \yJ)
\\[1ex]
&=
\P( X_1\mo\yme,\ X_{90}\mo\yhi,\ 
X_{3}\mo\yme \| X_{7}\mo\ylo,\ X_{5}\mo\yme,\ \yJ)
\end{aligned}$$
