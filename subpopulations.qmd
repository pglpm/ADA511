...
Given a statistical population with joint variates ${\green X}, {\red Y}$ (and possibly others), we define the [**conditional frequency**]{.blue} of the value ${\red y}$ of some variate ${\red Y}$, given (or "conditional on") the value ${\green x}$ of another variate ${\green X}$, as the frequency of the value of the first variate in the subpopulation selected by the value of the second variate. This frequency is usually written
