...
- [{{< fa cube >}} **Decisions**]{.blue}, also called [**courses of action**]{.blue}, available to the agent. They are assumed to be mutually exclusive and exhaustive; this can always be achieved by recombining them if necessary, as we'll discuss later.
