...
:::{.callout-note}
##
{{< fa exclamation-circle >}} We shall sometimes use the generic currency sign\ \ [**¤**]{.blue}\ \ to denote utilities, to make clear that gains and losses do not necessarily involve money, and not to reference any country in particular.
:::
...
Let apply the steps above in the assembly-line example of [ch. @sec-intro]:
...
- Peter must reach a particular destination, and is undecided between two alternatives: *go by car*, or *ride a bus*, or *go on foot*. If he goes by car, he could *arrive without problems*, with a probability of $80\%$ and a utility of $10\,\textcurrency$, or he could *get stuck in a traffic jam* and arrive late, with a probability of $20\%$ and a utility of $-10\,\textcurrency$.  If he rides a bus, he could *arrive without problems*, with a probability of $95\%$ and a utility of $15\,\textcurrency$, or arrive in time but *travelling in a fully-packed bus*, with a probability of $5\%$ and a utility of $-10\,\textcurrency$. If he goes on foot, he could *arrive without problems*, with a probability of $20\%$ and a utility of $20\,\textcurrency$, or he could *get soaked from rain*, with a probability of $80\%$ and a utility of $-5\,\textcurrency$.
    
	(We are using the symbol "$\textcurrency$" because Peter's utilities are a combination of money savings, time of arrival, and comfort.)
:::
...
We leave this question as a cliff-hanger, and get back to it after we explore more in detail how probabilities and utilities are assessed.

:::{.callout-caution}
## {{< fa user-edit >}} Exercise
Feel free to sketch an algorithm or a mathematical formula for determining the optimal decision, once all probabilities and utilities are known. Observe the way you reasoned in all decision-problem examples so far, and try to systematize it. The goal is *not* to get the correct answer, but to become more familiar with all the notions and ideas behind a basic decision problem.
:::
...
The solution of a basic decision-making problem can be roughly divided into three main stages: inference or probability assessment, utility assessment, and expected-utility maximization.
...
We shall now explore each of these three stages in the order above. We take up inference next because it is the most demanding and probably the one that can be optimized the most by new technologies.
