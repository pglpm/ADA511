...
- §1.1.4 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)

- *Skim through* Ch. 15 of [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules). No need to read thoroughly: just quickly glimpse whether there are ideas and notions that look familiar (a little like when you're in a large crowd and look quickly around to see if there are any familiar faces)
:::
