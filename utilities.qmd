...
- [*On making life and death decisions*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
...
::: {.callout-tip}
## {{< fa rocket >}} For the extra curious
- [*Decisions with Multiple Objectives*](https://hvl.instructure.com/courses/32045/modules)
- Chapter 8 of Sox & al. [*Medical Decision Making*](https://hvl.instructure.com/courses/32045/modules)
:::
::::
...
- §15.3.1 of [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)

- Final **Summary** (pp. 234--235) of chapter 8 in Sox & al. [*Medical Decision Making*](https://hvl.instructure.com/courses/32045/modules)

- §§ 9.14--9.17 of Lindley: [*Making Decisions*](https://hvl.instructure.com/courses/32045/modules)

- §4.2 of Keeney & al. 1976/1993: [*Decisions with Multiple Objectives*](https://hvl.instructure.com/courses/32045/modules)

- Skim through Dawes & al. 1985: [*Attitude and opinion measurement*](https://hvl.instructure.com/courses/32045/modules)
:::
...
::: {.callout-warning}
## {{< fa book >}} Study reading
- *A theory of human behavior* (pp. 30-37) in chapter 2 of Eells: [*Rational Decision and Causality*](https://hvl.instructure.com/courses/32045/modules)

- Morrison 1967: [*On the consistency of preferences in Allais' paradox*](https://hvl.instructure.com/courses/32045/modules)

- Skim through §9 (pp. 80--86) in chapter 4 of Raiffa: [*Decision Analysis*](https://hvl.instructure.com/courses/32045/modules)
:::
