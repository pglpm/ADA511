...
where $\$C$ is the total money capital, or a fraction thereof, owned by a person. Suppose that a person owing a capital $\$C = \$20 000$ is offered the two bets above. The utilities of the various wins and losses for the bets above are

$$
\begin{aligned}
\uu(\$10 010) &\approx 0.41
\\
\uu(-\$10 000) &\approx -0.69
\\[1ex]
\uu(\$1) &\approx 0.000 050
\\
\uu(-\$1) &\approx -0.000 050
\end{aligned}
$$
