...
Keep in mind that the background information $\yI$ also includes previous decisions and outcomes, if the present decision is part of a sequence. Because of this, when a decision problem occurs again, the utility of a particular decision and outcome may be different from the previous ones.
