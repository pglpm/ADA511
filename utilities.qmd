...
where $\$C$ is the total money capital, or a fraction thereof, owned by a person. When $x$ is very small compared to $C$, we have that\ \ $\uu(\$x) \approx x$.\ \ But when the magnitude of $x$ becomes comparable to $C$, the utility is no longer simply equal to $x$; losses are amplified, and wins are devalued. A loss of $\$C$ has a utility of $-\infty$.
