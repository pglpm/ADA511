...
## Utilities as an evaluation metric {#sec-utilities-metric}
...
:::{.purple}
- It is important to enquire what the exact *goals* and *whys* of an engineering or data-science problem really are. Otherwise you may end up spending wasting a lot of time developing the solution to the wrong problem.
...
::: {.callout-warning}
## {{< fa book >}} Study reading
- *A theory of human behavior* (pp. 30-37) in chapter 2 of [*Rational Decision and Causality*](https://hvl.instructure.com/courses/25074/modules/items/730251)

- [*On the consistency of preferences in Allais' paradox*](https://hvl.instructure.com/courses/25074/modules/items/730602)

- Skim through § 9 (pp. 80--86) in chapter 4 of [*Decision Analysis*](https://hvl.instructure.com/courses/25074/modules/items/664382)
:::
