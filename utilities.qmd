...
[**Utility**]{.blue} is the name we give to the real number that encodes together all heterogeneous desirabilities and gains of a consequence. The convention is that the higher the utility, the more desirable is the consequence.^[With the opposite convention we speak of *disutility* or *loss*.]
...
Keep in mind that the background information $\yI$ also includes previous decisions and outcomes, in the present decision is part of a sequence of decisions. Because of this, when a decision problem occurs again, the utility of a particular decision and outcome may be different from the previous ones.
...
But the utility of another $ 1-loss at the second toss might be lower, say $\blue -1.1$:
...
and so on. The decreased utility, even if the conditions at each coin toss are the same, may for example arise from the importance of the accumulated loss compared to your savings.
:::
