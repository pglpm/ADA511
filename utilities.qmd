...
Examination of these would-be counterexamples show that they actually contain logical inconsistencies in the application of decision theory. The most common mistake is that *they base utilities on particular aspects of the decision-making problem, but then use the probabilities of different aspects*. Let's show this inconsistency with an extreme example that illustrates it clearly.
...
Note that the utilities do *not* depend on the probabilities, as required by the independence axiom. The principle of maximal expected utility leads to decision $\sA$, the gambler's favourite.
