...
Let's apply this formula. Suppose that a person owing a capital $\$C = \$20 000$ is offered the two bets above. The utilities of the various wins and losses for the bets above are

$$
\begin{aligned}
\uu(\$10 010) &\approx 8116
\\
...
The expected utility of bet A is approximately $-2873$, and that of bet B is approximately $0$. Thus the principle of maximal expected utility leads to bet B as the optimal choice! What's needed are not alternative principles, but a correct utility assessment.
