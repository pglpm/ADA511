...
- {{< fa rocket >}}\ \ build "optimal predictor machines" that can deal with more complex kind of data
...
- {{< fa flask-vial >}}\ \ look for new technologies that can make possible the complicated computations required by an optimal predictor machine

- {{< fa tower-cell >}}\ \ disseminate what you have learned here, or find ways to make it more understandable
...
- J.-M. Bernardo, A. F. Smith (1994): [*Bayesian Theory*](https://hvl.instructure.com/courses/25074/modules/items/676153)

- H. Raiffa (1968): [*Decision Analysis: Introductory Lectures on Choices under Uncertainty*](https://hvl.instructure.com/courses/25074/modules/items/664382)

- S. J. Russell, P. Norvig (1995): [*Artificial Intelligence: A Modern Approach*](https://hvl.instructure.com/courses/25074/modules/items/660089) Parts I--IV (chapters 1--19).
