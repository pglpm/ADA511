...
...Or maybe I should say: ***Good luck on your new journey!** -- Because this is just the beginning.

What I hope you have taken from this course is a big picture of the science underneath data science and data-driven engineering, with a clear idea of its main (and few!) principles. You can now apply these principles to engineering problems similar to those explored in this course, and to other, more challenging problems. The principles you have learned are exactly the same.
...
I hope that you will use basic probability theory, decision theory, and their notation as tools to *frame* and *organize* inference, prediction, and decision problems.
...
For example, see again how the basic probability notation helped us classify different types of inference in [chapter @sec-kinds-inferences]. The notation even suggested at once how to correctly deal with partially missing data ([§@sec-categ-probtheory]).


### The basic, universal formula behind all supervised- and unsupervised-learning algorithms

I also hope that you will not forget, and actually use as much as possible, the basic formula ([chapter @sec-kinds-inferences]) that represents how an agent doing any kind of supervised- or unsupervised-learning works. This formula is what a neural network or a random forest are doing under the hood, even if just in an approximate way:
...
### Further texts and software

If you are looking for further texts or software to deepen your understanding of the probability calculus and decision theory, I recommend the ones below. But remember that it's a good idea to explore on your own. Try and skim through texts you find -- you may stumble onto very interesting good ones.

- [***Prova***: probabilistic-statistical variate analysis](https://github.com/pglpm/prova) (also on [CRAN](https://cran.r-project.org/package=prova)). This in an R package that essentially extends our Optimal Predictor Machine (from [chapter @sec-code-design] and following) to variates that can also be ordinal, continuous, bounded, rounded, and their combinations. You should be able to immediately use it and to understand what it does without any problem.
