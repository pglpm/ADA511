...
#### [{{< fa star-half >}} {{< fa star-half >}}]{.darkblue}\ \ All predictors of previous units, but not their predictands, are known to the agent
...
### [{{< fa sign-out-alt >}} {{< fa cube >}}]{.darkgrey}\ \ Tasks where an agent must itself *generate* a new unit
