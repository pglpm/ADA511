...
It is also possible that they don't know that there are only five of six fundamental laws upon which any inference, prediction, classification, regression, decision task is (or ought to be) based upon. Because this is a kind of knowledge that they don't need.
