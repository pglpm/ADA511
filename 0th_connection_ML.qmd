...
Again we see that the [machine-learning classifier]{.yellow} makes more correct guesses than the [optimal predictor machine]{.blue}, but the latter yields a higher utility.
