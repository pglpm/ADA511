...
- {{< fa exclamation-triangle >}}\ \ A statistical population is only a conceptual device for simplifying and facing some inference or decision problem. There is no objectively-defined population "out there".
