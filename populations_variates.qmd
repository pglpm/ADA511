...
:::{.callout-caution}
## {{< fa user-edit >}} Exercises
- Download the dataset^[This is an adapted version of the [UCI `Adult` dataset](https://doi.org/10.24432/C5XW20)] [`income_nominal_data_all.csv`](datasets/income_nominal_data_all.csv) (4 MB):
