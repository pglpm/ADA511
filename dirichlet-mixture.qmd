...
\\[1ex]
&\qquad{}=
\frac{0.206 811 }{0.206 811 + 0.150 133}
\\[1ex]
&\qquad{}=
\boldsymbol{57.94\%}
\end{aligned}
...
\cdot
\frac{
\bigl(6\cdot 2^{\alpha} -1 \bigr)!
}{
{\bigl(2^{\alpha} - 1\bigr)!}^6
}
\\[1ex]
&\qquad{}=
\boldsymbol{1}
...
\\[1ex]
&\qquad{}=
\frac{0.033 647 6}{0.033 647 6 + 0.014 556 7}
\\[1ex]
&\qquad{}=
\boldsymbol{69.80\%}
\end{aligned}
