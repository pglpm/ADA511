...
## Data pre-processing {#sec-1stconn-preprocess}
...
*It is important that you understand that such data pre-processing is **not** something that one has to do in data science in general -- quite the opposite, in principle you should **not** do it, because it is a destructive procedure. Such pre-processing is done in order to correct deficiencies of the algorithms currently in use.*
...
More formally, this is the content of the [**data-processing theorem**]{.blue} from information theory:

:::: {.callout-note style="font-size:120%"}
## Data-processing theorem
:::{style="font-size:120%"}
"No clever manipulation of the data can improve the inferences that can be made from the data" ([*Elements of Information Theory* § 2.8]{.small})
:::
::::

In other words (quoting *Information Theory, Inference, and Learning Algorithms*), [*data processing can only destroy information*]{.blue}.
