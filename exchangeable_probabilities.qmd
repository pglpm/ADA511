...
for any two different units [#$a$]{.yellow} and [#$b$]{.yellow}. Therefore, if the agent has specified $\P(X_{1}\mo\yy\|\yI)$, then three of these four probabilities

$$
\begin{gathered}
\P(X_{a}\mo\yy \and X_{b}\mo\yy \| \yI)\qquad
\P(X_{a}\mo\yy \and X_{b}\mo\yn \| \yI)\\[1ex]
\P(X_{a}\mo\yn \and X_{b}\mo\yy \| \yI)\qquad
\P(X_{a}\mo\yn \and X_{b}\mo\yn \| \yI)
\end{gathered}
$$
