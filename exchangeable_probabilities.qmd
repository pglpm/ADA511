...
b. Consider an infinite population with variates $(U,V)$ having joint domain $\set{\ymi,\ypl} \times \set{\yva, \yvb, \yvc}$ (six possible joint values). If the background information $\yK$ guarantees exchangeability, then these two joint probabilities must have the same value:
    
    $$\begin{aligned}
    &\quad\P(
	U_{14}\mo\ypl\and V_{14}\mo\yvc \ \and\ 
	U_{337}\mo\ypl\and V_{337}\mo\yva \ \and\ 
	U_{8}\mo\ymi\and V_{8}\mo\yvb \ \and\ 
	U_{43}\mo\ymi\and V_{43}\mo\yva \and{}
	\\
	&\qquad\qquad\qquad\quad
	U_{825}\mo\ypl\and V_{825}\mo\yva \ \and\ 
	U_{66}\mo\ypl\and V_{66}\mo\yva \ \and\ 
	U_{700}\mo\ymi\and V_{700}\mo\yvb
	\| \yK)
	\\[3ex]
	&=\P(
	U_{421}\mo\ypl\and V_{421}\mo\yva \ \and\ 
	U_{55}\mo\ymi\and V_{55}\mo\yvb \ \and\ 
	U_{43}\mo\ypl\and V_{43}\mo\yvc \ \and\ 
	U_{14}\mo\ymi\and V_{14}\mo\yva \and{}
	\\
	&\qquad\qquad\qquad\quad
	U_{928}\mo\ypl\and V_{928}\mo\yva \ \and\ 
	U_{700}\mo\ymi\and V_{700}\mo\yvb \ \and\ 
	U_{39}\mo\ypl\and V_{39}\mo\yva
	\| \yK)
	\end{aligned}
    $$
    
    because both have: one $(\ymi,\yva)$,\ \ two $(\ymi,\yvb)$,\ \ zero $(\ymi,\yvc)$,\ \ three $(\ypl,\yva)$,\ \ zero $(\ypl,\yvb)$,\ \ one $(\ypl,\yvc)$.
:::
