...
So far we have learned about the principles behind drawing inferences and about various properties of data. Using only the four fundamental probability rules that drive the "thinking" of a perfect AI agent, we arrived at a formula that underlines many different kinds of inference, prediction, and data-generation tasks:
