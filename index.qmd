...
[{{< fa exclamation-triangle >}}]{.red} trying to improve an approximation that has already attained the theoretical optimum. Think about an engine that has already the maximal efficiency dictated by thermodynamics; but an engineer, ignorant of thermodynamics, wastes effort in trying to improve it further.
