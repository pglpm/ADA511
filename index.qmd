...
A car mechanic, for instance, can keep your car in top-notch condition; can do different kinds of easy and difficult repairs if problems arise with it; knows whether a particular brand of valve can be used as a replacement for another brand; knows what is the optimal kind of tyres to use in a given season for different brands of cars. But a car mechanic would face difficulties in, say, assessing the power output and strain caused by a new kind of chemical fuel, or designing a new airbag system with increase safety, or calculating the optimal surface curvature of a new kind of spoiler. A car mechanic typically possesses a large amount of specific knowledge and doesn't need to know in depth the principles of thermomechanics and thermochemistry.

Vice versa, an automotive engineer
