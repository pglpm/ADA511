...
- explaining how the (five) fundamental rules of inference and decision making enter in a particular machine-learning algorithm;
- identify the inferential and decision-theoretic sub-optimal approximations are made by current machine-learning algorithms;
- exploit new technologies to build new algorithms that do calculations closer to the exact theoretical ones, thereby getting closer to the theoretical optimum.
