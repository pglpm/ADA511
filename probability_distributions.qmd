...
\P(24 \|\yI)
$$
Their values are stored in [this `csv` file](failure_probability.csv) and plotted in the histogram on the side.
...
- Load the [`csv` file](failure_probability.csv) containing the probabilities.
