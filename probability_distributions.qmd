...
$$
\underbracket[0ex]{\p}_{\mathrlap{\color[RGB]{119,119,119}\!\uparrow\ \textit{lowercase}}}(X\mo x \| \yI) \coloneqq
\frac{
\overbracket[0ex]{\P}^{\mathrlap{\color[RGB]{119,119,119}\!\downarrow\ \textit{uppercase}}}(\pr{\(X\) has value between \(x-\epsilon/2\) and \(x+\epsilon/2\)} \| \yI)
}{\epsilon}
$$
