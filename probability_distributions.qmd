# Probability distributions {#sec-prob-distribs}
{{< include macros.qmd >}}
...
$$
{\greenT = 271\,\mathrm{K}} \ , \quad
{\greenT = 272\,\mathrm{K} \ ,} \quad
{\greenT = 273\,\mathrm{K} \ ,} \quad
{\greenT = 274\,\mathrm{K} \ ,} \quad
{\greenT = 275\,\mathrm{K}} \ .
$$
...
$$\begin{aligned}
\P({\greenT \mo 271\,\mathrm{K}} \| {\yellow\yI}) &= {\purple0.04} \\[1ex]
\P({\greenT \mo 272\,\mathrm{K}} \| {\yellow\yI}) &= {\purple0.10} \\[1ex]
\P({\greenT \mo 273\,\mathrm{K}} \| {\yellow\yI}) &= {\purple0.18} \\[1ex]
\P({\greenT \mo 274\,\mathrm{K}} \| {\yellow\yI}) &= {\purple0.28} \\[1ex]
\P({\greenT \mo 275\,\mathrm{K}} \| {\yellow\yI}) &= {\purple0.40}
\end{aligned}
$$
...
$$
\begin{aligned}
&\P({\greenT \mo 271\,\mathrm{K}} \| {\yellow\yI}) +
\dotsb +
\P({\greenT \mo 275\,\mathrm{K}} \| {\yellow\yI}) \\
&\quad{}= 
...
In the case of ordinal or interval quantities it is sometimes possible to express the probability as a *function* of the value. For instance, the probability distribution above could be summarized by this function of the value ${\greent}$:

$$
\P({\greenT\mo t} \| {\yellow\yI}) = 
{\purple\frac{({\greent}/\textrm{\small K} - 269)^2}{90}}
