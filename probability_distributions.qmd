...
## Distribution of probabilities among values {#sec-distribute-prob}
...
On the other hand, if we write probability densities as previously suggested, in this case as "$\p(T \mo 20\mathrm{°C} \| \yI)\,\di T$", then the density written this way is a pure probability: the units "$\mathrm{°C^{-1}}$" disappear because multiplied by $\di T$, which has the inverse units $\mathrm{°C}$.
...
- §§ 5.3.0--5.3.1 of [*Risk Assessment and Decision Analysis with Bayesian Networks*](https://hvl.instructure.com/courses/25074/modules/items/664427)
:::
