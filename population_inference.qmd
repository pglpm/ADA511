...
With the representation above, it seems that the desired inference would consist in the calculation of these probabilities, which exhaust the 2³ = 8 possibilities for the three unknown units, in the stock-exchange case:

:::{.column-page-right}
$$\begin{aligned}
&\P(C_{101}\mo\ypl,\ C_{102}\mo\ypl,\ C_{103}\mo\ypl
\| C_{100}\mo\ypl,\ C_{99}\mo\ypl,\ \dotsc,\ 
C_{3}\mo\ypl,\ C_{2}\mo\ymi,\ C_{1}\mo\ymi,\ \yi[s] )
\\[1ex]
&\P(C_{101}\mo\ymi,\ C_{102}\mo\ypl,\ C_{103}\mo\ypl
\| C_{100}\mo\ypl,\ C_{99}\mo\ypl,\ \dotsc,\ 
C_{3}\mo\ypl,\ C_{2}\mo\ymi,\ C_{1}\mo\ymi,\ \yi[s] )
\\[1ex]
&\dotso
\\[1ex]
&\P(C_{101}\mo\ymi,\ C_{102}\mo\ymi,\ C_{103}\mo\ymi
\| C_{100}\mo\ypl,\ C_{99}\mo\ypl,\ \dotsc,\ 
C_{3}\mo\ypl,\ C_{2}\mo\ymi,\ C_{1}\mo\ymi,\ \yi[s] )
\end{aligned}$$
:::

where $\yi[s]$ represent the state of knowledge in the stock-exchange scenario.
Similarly in the mars-prospecting one, with state of knowledge $\yi[M]$:

:::{.column-page-right}
$$\begin{aligned}
&\P(H_{101}\mo\yy,\ H_{102}\mo\yy,\ H_{103}\mo\yy
\| H_{100}\mo\yy,\ H_{99}\mo\yy,\ \dotsc,\ 
H_{3}\mo\yn,\ H_{2}\mo\yy,\ H_{1}\mo\yy,\ \yi[M] )
\\[1ex]
&\P(H_{101}\mo\yn,\ H_{102}\mo\yy,\ H_{103}\mo\yy
\| H_{100}\mo\yy,\ H_{99}\mo\yy,\ \dotsc,\ 
H_{3}\mo\yn,\ H_{2}\mo\yy,\ H_{1}\mo\yy,\ \yi[M] )
\\[1ex]
&\dotso
\\[1ex]
&\P(H_{101}\mo\yn,\ H_{102}\mo\yn,\ H_{103}\mo\yn
\| H_{100}\mo\yy,\ H_{99}\mo\yy,\ \dotsc,\ 
H_{3}\mo\yn,\ H_{2}\mo\yy,\ H_{1}\mo\yy,\ \yi[M] )
\end{aligned}$$
:::
