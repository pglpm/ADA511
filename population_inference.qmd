...
$$\begin{aligned}
&\P\bigl(C_{101}\mo\ypl,\ C_{102}\mo\ypl,\ C_{103}\mo\ypl
\|[\big]
\\[1ex]
&\P\bigl(C_{101}\mo\ymi,\ C_{102}\mo\ypl,\ C_{103}\mo\ypl
\|[\big]
\\[1ex]
&\dotso
\\[1ex]
&\P\bigl(C_{101}\mo\ymi,\ C_{102}\mo\ymi,\ C_{103}\mo\ymi
\|[\big]
\end{aligned}$$

Note that we are denoting `and` by the more compact comma "$,$" rather than the larger "$\land$" symbol.
...
$$
 \|[\big] C_{100}\mo\ypl,\ C_{99}\mo\ypl,\ \dotsc,\ 
C_{3}\mo\ypl,\ C_{2}\mo\ymi,\ C_{1}\mo\ymi,\ \yi[s] \bigr)
$$
