...
E.  Given that $G=6.67 \cdot 10^{-11}\,\mathrm{m^3\,s^{-2}\,kg^{-1}}$, $M = 5.97 \cdot 10^{24}\,\mathrm{kg}$ (mass of the Earth), and $r = 6.37 \cdot 10^{6}\,\mathrm{m}$ (radius of the Earth), [a rocket engineer needs to know](http://nasaphysics.cet.edu/escape-velocity.html)  how much is $\sqrt{2\,G\,M/r\,}$.
