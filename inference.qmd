...
By *drawing an inference* we mean, roughly speaking, to assess whether an outcome, hypothesis, conjecture, or piece of information is `true` or `false`, on the basis of some other input, data, or other assumptions or information.
