...
There are now some important tasks ahead of us. First, we want to introduce a flexible and enough general mathematical representation for the objects and the bases of an inference. Second, we want to know what are the rules for making correct inferences.
