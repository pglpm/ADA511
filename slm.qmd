...
The function creates two `csv` files: one containing the training data with all n-grams from the input text, and one containing the metadata, consisting in the vocabulary.
...
As a concrete example let's start with a simple text: the lyrics from Daft Punk's song *Around the World*

> Around the world, around the world.
> Around the world, around the world.

stored in the file [`texts/around_the_world.txt`]()
