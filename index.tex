...
\begin{document}
\maketitle
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, breakable, interior hidden, boxrule=0pt, borderline west={3pt}{0pt}{shadecolor}, enhanced, sharp corners]}{\end{tcolorbox}}\fi
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{user-edit} Very first exercise!}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{user-edit} Exercises}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{rocket} For the extra curious}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, leftrule=.75mm, title={}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-tip-color-frame, bottomrule=.15mm, leftrule=.75mm, title={}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{book} Reading}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-caution-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{user-edit} Exercise}, arc=.35mm]
...
\item
  ...
  probabilities? And where are they drawn from?
\end{itemize}
...
In logic and mathematical logic, this corresponds to the fact that to
prove some \emph{theorem}, we must always start from some \emph{axioms}.
There are ``inferences'' -- \emph{tautologies} -- that can be drawn
without requiring others; but they are all trivial, such as ``this
component failed early, or it didn't''. They are of little use in a real
problem, although they have a deep theoretical importance.

\hypertarget{basic-elements-of-an-inference}{%
\section{Basic elements of an
inference}\label{basic-elements-of-an-inference}}

Let us introduce one element of the mathematical notation for
inferences.
...
To calculate the probability for such an inference, we start from those
of other inferences. A basic inference process therefore can be
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{exclamation-circle} We must be wary of how much we shorten
sentences}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{exclamation-circle} Important subtleties of the connectives:}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-warning-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-warning-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{exclamation-circle} Careful}, arc=.35mm]
...
variety of deduction systems}. The picture on the margin, for instance,
shows how a proof of how our inference would look like, using the
so-called sequent calculus.
...
\caption{The {bottom formula} is the desired inference. Each line
denotes the application of an inference rule,. The two formulae with no
line above are the {initial, known inference}, and a tautology.}
...
out of nothing: {\textbf{in order to draw an inference, we must always
start from other, known inferences}}. This is a central point in logic.
It is sometimes stated in terms of \emph{axioms} and \emph{theorems}: in
order to prove some theorem, we must always start from some axioms.
There are ``inferences'' -- \emph{tautologies} -- that can be drawn
without requiring others; but they are all trivial, such as ``this
component failed early, or it didn't''. They are of little use in a real
problem, but are important because they reflect the core of the
inference rules.

\hfill\break

We can compactly encode all logical inference rules in the following
way. First, represent \texttt{true} by the number \texttt{1}, and
\texttt{false} by \texttt{0}. Second, symbolically write that the
proposal \(\mathsfit{Y}\) is \texttt{true}, given the conditional
\(\mathsfit{X}\), as follows: \[
\mathrm{T}(\mathsfit{Y}\nonscript\:\vert\nonscript\:\mathopen{} \mathsfit{X}) = 1
\] or {``\(=0\)''} if it's \texttt{false}.

The rules of truth inference are then encoded by the following
equations, which must always hold for any sentences
\(\mathsfit{X},\mathsfit{Y},\mathsfit{Z}\) (atomic or complex):
...
inference would look like, using the so-called
\href{https://plato.stanford.edu/archives/sum2023/entries/logic-propositional/\#SequCalc}{sequent
calculus}.
...
\begin{tcolorbox}[enhanced jigsaw, breakable, toprule=.15mm, colframe=quarto-callout-important-color-frame, opacityback=0, bottomrule=.15mm, rightrule=.15mm, arc=.35mm, leftrule=.75mm, colback=white, left=2mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-note-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-note-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{landmark}~~~THE FUNDAMENTAL LAWS OF
INFERENCE~~~\faIcon{landmark}}, arc=.35mm]
...
\begin{tcolorbox}[enhanced jigsaw, bottomtitle=1mm, toprule=.15mm, colback=white, opacityback=0, rightrule=.15mm, coltitle=black, colbacktitle=quarto-callout-important-color!10!white, left=2mm, titlerule=0mm, breakable, toptitle=1mm, opacitybacktitle=0.6, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, leftrule=.75mm, title={\faIcon{exclamation-circle} Differences in terminology}, arc=.35mm]
