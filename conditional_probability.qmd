...
Suppose that an agent, with background information $\yI$, has a joint probability distribution for the joint quantity $(U_1, U_2, U_3)$, implicitly defined as follows:
<!-- 0 53.6  -->
<!-- 1 11.4  -->
<!-- 2 3.6  -->
<!-- 3 1.4  -->
...
<!--      i1 i2 i3        p   num  den -->
<!-- [1,]  0  0  1 0.175385 0.114 0.65 -->
<!-- [2,]  0  1  1 0.240000 0.036 0.15 -->
<!-- [3,]  1  0  1 0.240000 0.036 0.15 -->
<!-- [4,]  1  1  1 0.280000 0.014 0.05 -->
