...
- {{< fa cube >}} There is a decision or choice to make, or act to be executed (and "not deciding" is not an option, or it's just another kind of choice).
...
In fact instead of *decision* we could use the term [*course of action*]{.blue}, which is also commonly used in decision theory, or simply *action*.
