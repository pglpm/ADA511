...
We must try to make sense of the $10\%$ probability that the component fails within a year. Different people do this with different imagination tricks. We can imagine, for instance, that this situation is repeated [100 times]{.yellow}. In [10]{.yellow} of these repetitions the accepted electronic component is sold and fails within a year after selling. In the remaining [90]{.yellow} repetitions, the component is sold and works fine for at least a year.
...
- [If the bet is "heads"]{.yellow} and the coin lands [heads]{.green}, the person [wins a *small* amount]{.green} of money; but if it lands [tails]{.red}, they [lose a *large* amount]{.red} of money.
- [If the bet is "tails"]{.green} and the coin lands [tails]{.green}, the person [*wins* a small amount]{.green} of money; if it lands [heads]{.red}, they [lose the same *small* amount]{.red} of money.
...
[Henry chooses the "heads" bet]{.yellow}. [Tina chooses the "tails" bet]{.green}. The coin comes down [heads]{.midgrey}. So Henry wins the small amount of money, while Tina loses the same small amount.

What would we say about their decisions?

[Henry's decision]{.yellow} was lucky, and yet *irrational*: he risked losing much more money than he could win. [Tina's decision]{.green} was unlucky, and yet *rational*: she wasn't risking to lose more than she could win. Said otherwise, the two bets had the same winning prospects, but the ["heads"]{.yellow} bet had more risk of loss than the ["tails"]{.green} bet.
...
- even if there is no method to determine which decision is successful, there is a method to determine which decision is rational or [**optimal**]{.blue}, given the particular gains, losses, and uncertainties involved in the decision problem
