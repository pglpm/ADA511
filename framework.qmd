...
In the scenarios that we explored above, we found an extremely important problem-pattern:\ \ {{< fa cube >}} There is a decision or choice to make (and "not deciding" is not an option, or it's just another kind of choice).\ \ {{< fa cube >}} Making a particular decision will lead to some consequences. Some consequences are desirable, others are undesirable.\ \ {{< fa cube >}} The decision is difficult to make, because its consequences are not known with certainty, even considering the information and data available in the problem: we may lack information and data about past or present details, about future events and responses, and so on.
...
[Henry's decision]{.yellow} was lucky, and yet *irrational*: he risked losing much more money than he could win. [Tina's decision]{.lightblue} was unlucky, and yet *rational*: she wasn't risking to lose more than she could win. Said otherwise, the two bets had the same prospects, but the [heads-bet]{.yellow} had more risk of loss than the [tails-bet]{.green}.
...
- {{< fa hand-point-right >}} "Success" is generally not a good criterion to judge a decision under uncertainty. Success can be the pure outcome of luck, not of smarts.
