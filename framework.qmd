...
The basic idea is that the agent will estimate effects of the unknowns given the assumptions, and from this estimate choose the optimal course of action.
