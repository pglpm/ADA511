...
## The broad meaning of "decision" and the universality of decision-making in AI {#sec-meaning-decision}
...
In fact instead of *decision* we could use the term [*course of action*]{.blue}, which is also commonly used in decision making, or simply *action*.

[**It is this more general sense of "decision" and "decision-making" that we study in this course.**]{.blue} In this more general sense, decisions permeate every second of any human being and of any machine. **Decision-making of all kinds occurs continuously and determines the behaviour of any agent equipped with Artificial Intelligence.**

Thus, by studying decisions and decision-making, we're studying how AI agent should behave.


## Our focus: decision-making, inference, and data science {#sec-our-focus}

Every data-driven engineering problem and AI task is unique, with unique difficulties, questions, issues. But there are some general aspects that are common to all such problems.
