...
- [{{< fa check >}} t is susceptible to recursive, sequential, or modular application]{.green}
...
*Normative* contrasts with *descriptive*. The purpose of Decision Theory is not to describe, for example, how human decision-makers typically work. Because human decision-makers typically make irrational, sub-optimal, or biased decisions. That's exactly what we want to avoid and improve!
