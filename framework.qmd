...
- [**Agent**]{style="color:#4477AA;"}: the person or device that has to make an optimal decision.

- [**Decisions**]{style="color:#4477AA;"} or [**courses of actions**]{style="color:#4477AA;"}: the choices available to the agent.

- [**Assumptions**]{style="color:#4477AA;"}: data and background information that are known, or temporarily imagined to be known, to the agent.
...
- *Agent*: the automated inspector (and indirectly the engineer who designed and programmed it).
...
2. Should the automated inspector `approve` or `discard` this new component? Try to make a decision on intuitive grounds, trying to interpret what the probabilities and utilities given above could mean.
:::
