...
For instance, let's see three samples of how the full-population frequency distribution for $\mathit{sex} \and \mathit{income}$ (jointly) could be:
...
print(aperm(result) * 100) # permute so that samples are the last array dimension
```
