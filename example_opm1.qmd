...
[You can find a Jupyther notebook associated with the present chapter: [`example_opm1.ipynb`](https://github.com/pglpm/ADA511/blob/master/code/OPM-nominal/opm_adultincome_example.ipynb), but note that it's less annotated and partly unmaintained ([not a fan of Jupyther](https://www.youtube.com/watch?v=7jiPeIFXb6U), sorry).]{.grey .small}
