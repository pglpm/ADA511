...
Now let's consider a scenario where, in order to save resources, we can only use *one* variate in order to infer the income. Which of the other variates should we prefer? We can calculate the mutual information of each of them and $\mathit{income}$:
