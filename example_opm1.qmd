...
We start loading the R functions needed at several stages. Make sure you are in a directory homologous to `code/OPM-nominal/`:
...
Now inspect the result
 ...
 to be considered is listen on the first column of [this `csv` table](
https://github.com/pglpm/ADA511/blob/master/code/OPM-nominal/meta_income_data_nominal_nomissing.csv).
