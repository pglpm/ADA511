...
: Arguments:
	...
	Output:
	: - an object of type `agent`, consisting of a list of an array `counts` and three vectors `alphas`, `auxalphas`, `palphas`.
...
{{< fa code >}} [`plotFsamples1D(agent, n=100, predictand=NULL, predictor=NULL, probability=TRUE, file=NULL, ...)`](https://github.com/pglpm/ADA511/blob/master/code/OPM-nominal/plotFsamples1D.R)
: (plot population-frequency samples)
