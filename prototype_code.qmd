...
{{< fa code >}} [`guessmetadata(data, file=NULL)`](https://github.com/pglpm/ADA511/blob/master/code/guessmetadata.R)
: Arguments:
...
{{< fa code >}} [`buildagent(metadata, data=NULL, kmi=0, kma=20)`](https://github.com/pglpm/ADA511/blob/master/code/buildagent.R)
: Arguments:
...
{{< fa code >}} [`infer(agent, predictand=NULL, predictor=NULL)`](https://github.com/pglpm/ADA511/blob/master/code/infer.R)
: Arguments:
...
{{< fa code >}} [`decide(probs, utils=NULL)`](https://github.com/pglpm/ADA511/blob/master/code/decide.R)
: Arguments:
...
{{< fa code >}} [`rF(n=1, agent, predictand=NULL, predictor=NULL)`](https://github.com/pglpm/ADA511/blob/master/code/rF.R)
: (generate population-frequency samples)

{{< fa code >}} [`mutualinfo(agent, A, B, base=2)`](https://github.com/pglpm/ADA511/blob/master/code/mutualinfo.R)
