...
:::{.callout-warning}
## {{< fa exclamation-circle >}} Beware of *likelihood* as a synonym for *probability*
...
- [**{{< fa hand-point-right >}} Probabilities are agent- and context-dependent**]{.blue}. A coin is tossed, comes down heads, and is quickly hidden from view. Alice sees that it landed heads-up. Bob instead doesn't manage to see the outcome and has no clue. Alice considers the sentence $\pr{Coin came down heads}$ to be `true`, that is, to have $100\%$ probability. Bob considers the same sentence to have $50\%$ probability.
...
- Skim through §§ 2.0--2.4 of [*Probability Theory*](https://hvl.instructure.com/courses/25074/modules/items/660090)
:::
...
$$
\green\P(\lnot\yh \| \yf \land \yJ) = \P(\lnot\ys \| \yf \land \yJ)
$$
