...
[**Skim through**]{.lightblue} Diaconis & al. 2007: [*Dynamical Bias in the Coin Toss*](https://hvl.instructure.com/courses/32045/modules).
...
- Ch. 2 of Gregory: [*Bayesian Logical Data Analysis for the Physical Sciences*](https://hvl.instructure.com/courses/32045/modules)

- Ch. 1 of O'Hagan: [*Probability*](https://hvl.instructure.com/courses/32045/modules)

- §§1.0--1.2 of Sivia: [*Data Analysis*](https://hvl.instructure.com/courses/32045/modules)

[**Skim through**]{.lightblue}:

- Cox 1946: [*Probability, Frequency and Reasonable Expectation*](https://hvl.instructure.com/courses/32045/modules). Try to get the ideas behind the reasoning, even if you can't follow the mathematical details.

- Chs 1--2 of Jaynes: [*Probability Theory*](https://hvl.instructure.com/courses/32045/modules)
:::
...
## Use and implementation of the inference rules

In the [solution above](#sec-solution-first-probinference) you noticed that the equations of the fundamental rules are not only used to obtain some of the probabilities appearing in them from the remaining probabilities.
...
- §12.2.3 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules)

As you continue your studies, [**skim through**]{.lightblue} chapters 4--8 of Hastie & Dawes: [*Rational Choice in an Uncertain World*](https://hvl.instructure.com/courses/32045/modules), just to get the main messages and an overview of curious psychological phenomena.
:::
...
A once-famous paper in the quantum-theory literature: Brukner & Zeilinger 2000: [Conceptual inadequacy of the Shannon information in quantum measurements](https://hvl.instructure.com/courses/32045/modules) arrived at completely wrong results simply by omitting background information, mixing up probabilities having different conditionals.
:::
::::
