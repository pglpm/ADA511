...
In these notes we'll avoid the possibly confusing term "likelihood". All that we need to express can be phrased in terms of "probability".

### Invisible background information
