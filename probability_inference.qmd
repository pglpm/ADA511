...
For example, if we have $\P(a \land b\| D)=0.2$ and  $\P(a\|D)=0.7$, from the and-rule we find $\P(b\| a \land D)$:
$$
\P(b\| a \land D) = \frac{\P(a\land b \| D)}{\P(a\|D)} = \frac{0.2}{0.7} 
\approx 0.2857
$$
