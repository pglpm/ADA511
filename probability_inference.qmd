...
<!-- $$ -->
<!-- \begin{aligned} -->
<!-- &\underbracket{\color{#228833}\P(a \land b \| D)}_{0.2} -->
<!-- = {\color{#EE6677}\P(b \| a \land D)} \cdot -->
<!-- \underbracket{\color{#228833}\P(a \| D)}_{0.7} -->
<!-- \quad\Longrightarrow -->
<!-- \\ -->
<!-- &\quad{\color{#EE6677}\P(b\| a \land D)} =  -->
<!-- \frac{ -->
<!-- \color{#228833}\P(a\land b \| D) -->
<!-- }{ -->
<!-- \color{#228833}\P(a\|D) -->
<!-- } = \frac{0.2}{0.7}  -->
<!-- \approx 0.2857 -->
