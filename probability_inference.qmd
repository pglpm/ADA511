...
Extending our truth-inference notation to probability-inference notation has been straightforward. But how do the rules for truth-inference, [formulae @eq-t-not, @eq-t-or, @eq-t-and, @eq-t-unity], extend to rules for probability-inference?
