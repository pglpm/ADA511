...
<!-- You can find an implementation of the algorithm above in the [R function `findP()`](https://github.com/pglpm/ADA511/blob/master/code/findP.R). This -->
<!-- function takes as first argument the probability we want to find, and as remaining arguments the values of the given probabilities. -->
