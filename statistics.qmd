...
::: {.callout-caution}
## {{< fa book >}} Study reading
§ 2.1 of [*Risk Assessment and Decision Analysis with Bayesian Networks*](https://hvl.instructure.com/courses/25074/modules/items/664427)
:::
...
::: {.callout-tip}
## {{< fa rocket >}} For the extra curious
Ch. 21 of [*Probability Theory*](https://hvl.instructure.com/courses/25074/modules/items/660090)
:::
::::
