...
To identify or attribute a "type" a quantity we must ultimately [*check how that quantity is defined, obtained, and used*]{.blue}. In some cases the values of the quantity may give some clue; for example, if we see values ["$2.74$",]{.m} ["$8.23$",]{.m} ["$3.01$",]{.m} then the quantity is probably of the interval kind. But if we see values ["$1$",]{.m} ["$2$",]{.m} ["$3$",]{.m} it's unclear whether the quantity is interval, ordinal, nominal, or maybe of yet some other kind.
