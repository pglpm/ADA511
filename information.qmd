...
- Read and **play** with a colleague "*The game of submarine*" on pp. 71--72 §4.1 of MacKay: [*Information Theory, Inference, and Learning Algorithms*](references.html).

- Watch {{< video https://www.youtube.com/watch?v=0SxJl5G2bp0 >}}.
...
[**Read**]{.lightblue} §12.4 of [*Artificial Intelligence*](references.html)


[**Skim through**]{.lightblue} Chapter 8 of MacKay: [*Information Theory, Inference, and Learning Algorithms*](references.html)

:::

## Difference between *shannons* and *bits* {#sec-diff-shannon-bit}

You'll notice that several texts that discuss information theory use the *bit*, rather than the *shannon*, as a measurement unit for entropy and mutual information, when base-2 logarithms are used. But there is actually a difference between these two units, and this difference is emphasized by the International Organization for Standardization (ISO), the International Electrotechnical Commission (IEC), and other standardization bodies:

- the [*shannon*](https://electropedia.org/iev/iev.nsf/display?openform&ievref=171-07-11) is a unit of *information* or *entropy*;
- the [*bit*](https://electropedia.org/iev/iev.nsf/display?openform&ievref=171-02-11) is a unit of *amount of data* or *memory storage*.

The difference between the two is of important -- especially for a data scientist! -- and simple to understand. Let's illustrate it with a simple example.

Suppose you're uncertain about a result with two possibilities, let's say the toss of a coin. You'd like to know the result, and also store it somewhere. I tell you the result, let's say "heads". Now you know it, and you also store it on your computer by changing the value of one binary digit. You have gained *one shannon* of information, and you've used *one bit* of memory in your computer to store it.

Now suppose that, for safety reasons, you make a backup of this small piece of information, flipping another binary digit in another region of your computer's memory. The piece of information now occupies *two bits* of memory storage -- but it's still just *one shannon* of information! Just because you copy that bit twice, or many more times, doesn't mean that your knowledge is increasing, or that you're gaining new information. If you have information (say, phone numbers of your contacts) stored as data, and you back-up those data, the amount of data has doubled, but the information you have has not suddenly doubled; it's the same as before. The amount of *bits* of data has doubled, but the amount of *shannons* of information has stayed the same. If you tell a piece of information (say a phone number, or a birthdate) to a friend, and you repeat it just to make sure your friend got it, then you doubled the amount of *bits* of data transmitted, but you didn't double the amount of *shannons* of information transmitted.

So it's important to keep in mind the difference between *information* and *amount of data*, and to reflect it by using two different units.
