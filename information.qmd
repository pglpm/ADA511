...
The notion of irrelevance of two sentences can be generalized to quantities. Take two quantities $X$ and $Y$. They are said to be [**mutually irrelevant** or **logically independent given information $\yI$**]{.blue} if any one of these three equivalent conditions holds [*for all possible values $x$ of $X$ and $y$ of $Y$*]{.blue}:
