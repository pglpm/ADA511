# Anatomy of decision problems
{{< include macros.qmd >}}

## Basic decision problems

Decision Theory analyses any decision-making problem in terms of nested or sequential *basic* or *minimal* decision problems; The assembly-line scenario of the [introduction @sec-intro] is an example. A basic decision problem can be represented by a diagram like this:
