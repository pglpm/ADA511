...
Some of these derived rules may seem obvious or unimportant, but actually are of extreme importance in data science. For instance the `and`-idempotence rule effectively asserts that [*whenever we draw inferences, redundant information or data is **automatically** counted only once*]{.blue}.
