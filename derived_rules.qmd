...
§8.8 of [*Rational Choice in an Uncertain World*](https://hvl.instructure.com/courses/32045/modules)
:::
...
::: {.callout-warning}
## {{< fa book >}} Study reading
- §§4.1--4.3 in [*Medical Decision Making*](https://hvl.instructure.com/courses/32045/modules) give one more point of view on Bayes's theorem.

- Ch. 3 of [*Probability*](https://hvl.instructure.com/courses/32045/modules)
