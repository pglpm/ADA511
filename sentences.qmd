...
Writing full sentences would take up *a lot* of space. Even expressions such as "[The voltage is 20 mV]{.midgrey}"
...
$$\textsf{\small`}\, O = 100\,\mathrm{W} \,\textsf{\small'}$$
where $O$ is a physical variable (not a sentence!) denoting the power output; or even just to [$\pr{100\,W}$.]{.together}
