...
- Take a *quick look* at these:
    - [*SMART: A propositional logic-based trade analysis and risk assessment tool for a complex mission*](https://hvl.instructure.com/courses/32045/modules)
	...
	- part IV in [*Model-based programming of intelligent embedded systems and robotic space explorers*](https://hvl.instructure.com/courses/32045/modules)
:::
...
::: {.callout-warning}
## {{< fa book >}} Study reading
Take a quick look at §7.4.1 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules) and note the similarities with what we've just learned. In these notes we follow a faster approach leading directly to probability logic.
:::
