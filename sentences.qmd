...
- Take a *quick look* at these:
    - [*SMART: A propositional logic-based trade analysis and risk assessment tool for a complex mission*](https://hvl.instructure.com/courses/25074/modules/items/668590)
...
- [**{{< fa hand-point-right >}} A meaningful phrase may not be a sentence**]{.blue}. For instance, a phrase like "[Apples are much tastier than pears]{.midgrey}" may not be a sentence, because it's a matter of personal taste whether it's `true` or `false`;  moreover, an agent's opinion about apples and pears might change from time to time.
    ...
    The phrase "[Jenny right now finds apples tastier than pears]{.midgrey}", on the other hand, could be a sentence; its truth being found by asking Jenny at that moment.
...
:::{.callout-warning}
## 
{{< fa exclamation-circle >}} Be particularly careful when reading scientific and engineering papers with a lot of technical terms and phrases: technical jargon often makes it especially difficult to understand whether something true or at least meaningful is being said, or not!
:::
