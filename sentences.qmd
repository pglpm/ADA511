...
[**Read**]{.lightblue} §7.1 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules).
...
::: {.callout-warning}
## {{< fa book >}} Study reading
[**Skim through**]{.lightblue} §7.4.1 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/32045/modules) and note the similarities with what we've just learned. In these notes we follow a faster approach leading directly to probability logic.
:::
...
- Ono & al. 2015: [*SMART: A propositional logic-based trade analysis and risk assessment tool for a complex mission*](https://hvl.instructure.com/courses/32045/modules)
- around p. 22 in Ingham 2012: [*No More Band-Aids: Integrating FM into the Onboard Execution Architecture*](https://hvl.instructure.com/courses/32045/modules)

<!-- - §2.1 in [*Deliberation for autonomous robots: A survey*](http://doi.org/10.1016/j.artint.2014.11.003) -->

- part IV in Williams & al. 2003: [*Model-based programming of intelligent embedded systems and robotic space explorers*](https://hvl.instructure.com/courses/32045/modules)
:::
