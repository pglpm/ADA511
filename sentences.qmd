...
::: {.callout-caution}
## {{< fa book >}} Reading
Just take a quick look at § 7.4.1 in [*Artificial Intelligence*](https://hvl.instructure.com/courses/25074/modules/items/660089) and note the similarities with what we've just learned.

Here we follow a faster approach leading directly to probability logic.
:::
