...
This algorithm gives us a way of choosing the order of doing splits, but you maybe noticed already in @eq-gain-binary-features that if we allow `Values(A)` to be numerical rather than categorical, 

## Trees for numerical features  
