...
We have already seen the tree-like structure for illustrating decision problems in chapter @sec-basic-decisions, but in this section, we are doing similar yet different things. The name of "decision trees" still pertain to both, but it should hopefully be clear from context when we are talking about what. 
