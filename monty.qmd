...
- [![](3b1b_spheres.jpg) The most underappreciated formula | Exploring high-dimensional spheres](https://www.3blue1brown.com/?topic=all&lesson=spheres-talk)
...
- Confirm the result using the [`inferP()`](https://pglpm.github.io/Pinference/reference/inferP.html) function introduced in [§@sec-algorithm-rules].
:::
...
- Assign utilities to winning the car or winning the goat from the point of view of an agent who values the car more. The available actions are, of course, "keep door 1" vs "switch to door 3". Then solve the decision-making problem according to the procedure of [§@sec-make-decision]. What's the optimal action?

- Now assign utilities from the point of view of an agent who values the *goat*
more than the car. Then solve the decision-making problem according to the usual procedure. What's the optimal action?
:::
