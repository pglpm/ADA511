...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{user-edit} Very first exercise!}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{user-edit} Exercises}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{rocket} For the extra curious}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{book} Reading}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{user-edit} Exercise}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\hypertarget{the-wide-scope-and-characteristics-of-inferences}{%
\section{The wide scope and characteristics of
inferences}\label{the-wide-scope-and-characteristics-of-inferences}}
...
There are now some important tasks ahead of us. First, we want to
...
sentences, offers many practical advantages. It leads to
\textbf{clarity} in engineering problems and makes them more
\textbf{goal-oriented}. A data engineer must acquire information and
convey information. ``Acquiring information'' does not simply consist in
making measurements or counting something: the engineer must understand
\emph{what} is being measured and \emph{why}. If data is gathered from
third parties, the engineer must ask what exactly the data mean and how
they were acquired. In designing and engineering a solution, it is
important to understand what information or outcomes the end user
exactly wants. The ``what'', ``why'', ``how'' are expressed by
sentences. A data engineer will often ask ``\emph{wait, what do you mean
by that?}''. This question is not just an unofficial parenthesis in the
official data-transfer workflow between the engineer and someone else.
It is an integral part of that workflow: it means that some information
...
abbreviate the sentence above to
\[\textsf{\small`}\, O = 100\,\mathrm{W} \,\textsf{\small'}\] where
\(O\) is a physical variable (not a sentence!) denoting the power
output; or even just to {\(\textsf{\small`100\,W'}\).}

We'll now see how more complex sentences are built from simpler ones. No
matter whether complex or simple, any sentence can be represented by
...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, colframe=quarto-callout-important-color-frame, colback=white, toprule=.15mm, left=2mm, rightrule=.15mm, bottomrule=.15mm, opacityback=0, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-note-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{landmark}~~~THE FUNDAMENTAL LAWS OF
INFERENCE~~~\faIcon{landmark}}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
...
\begin{tcolorbox}[enhanced jigsaw, colbacktitle=quarto-callout-important-color!10!white, left=2mm, rightrule=.15mm, coltitle=black, arc=.35mm, breakable, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, leftrule=.75mm, titlerule=0mm, title={\faIcon{exclamation-circle} Differences in terminology}, bottomrule=.15mm, opacityback=0, opacitybacktitle=0.6, colback=white]
