...
of \texttt{1\$}. If the component fails within a year of use, however,
the manufacturer incur net \emph{loss} of \texttt{10\$} (11\$ loss,
minus the 1\$ gained at first), owing to warranty refunds and damage
costs to be paid to the buyer. When a new electronic component is
discarded, the manufacturer has \texttt{0\$} net gain.
...
is a \texttt{10\%} probability that the component will fail within its
first year of use.
\end{quote}
...
\hypertarget{aspects-of-the-assembly-problem}{%
\section{Aspects of the assembly
problem}\label{aspects-of-the-assembly-problem}}

Let's approach the exercise of the Introduction~\ref{sec-intro} in an
intuitive way.
...
We must try to make sense of that \(10\%\) probability of failure within
a year. Different people do this with different imagination tricks. We
can imagine, for instance, that this situation is repeated 100 times. In
10 of these repetitions the accepted component fails within a year after
selling. In the remaining 90 repetitions, the component works fine for
at least a year.
...
\(10 \cdot 10\,\$ = 100\,\$\). In each of the 90 imaginary repetitions
in which the component doesn't fail early, the manufacturer gains
\(1\,\$\). That's a total gain of \(90\,\$\). So over all 100 imaginary
repetitions the manufacturer has gained \[
10\cdot (-10\$) + 90\cdot 1\$ = {\color[RGB]{238,102,119} -10\$} \ .
\] So actually the manufacturer has not gained, but \emph{lost}
\(10\,\$\) ! That's an average of \(0.1\,\$\) \emph{lost} per
repetition.

Now let's say that we \texttt{reject} the component instead. What
...
anything -- that is, the ``gain'' is \(0\,\$\) -- in all and each
repetitions.

The conclusion is that if in a situation like this we \texttt{accept}
the component, then we'll lose \(1\,\$\) on average; whereas if we
\texttt{reject} it, then on average we won't lose anything or gain
anything.

Obviously the best -- or ``least worst'' -- decision to make is to
\textbf{reject} the component.

\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{pen} Exercise}, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\item
  ...
  cost: is it still best to reject? For instance, try with
...
\item
  Consider the special case with failure probability
  \textbf{\texttt{0\%}} and failure cost \texttt{10\$}. This means no
  new component will ever fail. To decide in such a case we do not need
  imaginary repetitions, but \textbf{confirm} that we arrive at the same
  logical conclusion whether we reason through imaginary repetitions or
  not.
\end{enumerate}

\end{tcolorbox}

\hypertarget{peculiarities-of-the-problem}{%
\subsection{Peculiarities of the
problem}\label{peculiarities-of-the-problem}}
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={}, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{seedling}}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={Example}, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={Exercise}, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{book-open} For the curious}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-caution-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{book-open} Reading}, colframe=quarto-callout-caution-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{book-open} For the curious
\href{https://plato.stanford.edu/archives/win2020/entries/propositions}{Propositions}}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-tip-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{rocket} For the extra curious}, colframe=quarto-callout-tip-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, rightrule=.15mm, arc=.35mm, breakable, opacityback=0, colback=white, left=2mm, toprule=.15mm, colframe=quarto-callout-important-color-frame, bottomrule=.15mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{landmark}~~~THE FUNDAMENTAL LAWS OF
INFERENCE~~~\faIcon{landmark}}, colframe=quarto-callout-note-color-frame, bottomtitle=1mm, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, coltitle=black, breakable, toprule=.15mm, colbacktitle=quarto-callout-important-color!10!white, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, toptitle=1mm, rightrule=.15mm, colback=white, opacityback=0, titlerule=0mm, arc=.35mm, title={\faIcon{exclamation-circle} Differences in terminology}, colframe=quarto-callout-important-color-frame, bottomtitle=1mm, leftrule=.75mm]
