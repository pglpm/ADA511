...
Example of generalized histogram (from [Wolfram Mathematica](https://reference.wolfram.com/language/ref/Histogram3D.html))
:::
...
Example of density histogram (from [Wolfram Mathematica](https://reference.wolfram.com/language/ref/DensityHistogram.html))
:::
...
the points do not need to be scattered in regular fashion as long as it's clear which quantity value they are associated with.
