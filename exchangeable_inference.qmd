...
and the agent's belief distribution for the frequencies is proportional to
...
we see that all possible frequency distributions considered by this belief distribution.
