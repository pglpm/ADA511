...
What is the agent's degree of belief that cube #1 is labelled $\yy$? According to the derived rule of extension of the conversation, that is, the main formula written above:
...
In an analogous way we can calculate the agent's belief that cube #1 is $\yy$, cube #2 is  $\yn$, and cube #3 is $\yy$:
