...
This is the kind of inference that we explored in the "next-three-patients" scenario of [§ @sec-conditional-joint-sim] and in some of its following sections. In [chapter @sec-4-connection-ML], after a review of conventional machine-learning methods and terminology, we shall discuss with more care what these inferences are about, what kind of information they use, and how they can be concretely calculated.
