...
$\bZ_i$, $\bY_i$, $\bX_i$ will denote all quantities, the predictands, and the predictors of instance #$i$.

Recall that in the probability notation $\P(\dotsb\|\dotsb \and \yI)$
